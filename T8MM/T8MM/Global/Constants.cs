...
public static class Constants
{
    ...
    private const string USER_SETTING_FILE_NAME = "UserSetting.json";
    public static readonly string UserSettingFolder = $"{AppDomain.CurrentDomain.BaseDirectory}/user".Replace("//","/");
    public static string UserSettingFilePath = Path.Combine(UserSettingFolder, USER_SETTING_FILE_NAME);
}
